    ...
    <section className="pt-6 pb-12 bg-white dark:bg-gray-900 text-center font-[Cambria] text-gray-800 dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="flex flex-col items-center gap-10 px-4">
        ...
        <div
          ...
          className="cursor-pointer bg-[#f3e8ff] dark:bg-[#3b2a5d] border border-violet-300 dark:border-violet-700 text-gray-800 dark:text-gray-100 w-full max-w-5xl py-8 px-6 rounded-2xl flex flex-col md:flex-row justify-between items-center shadow-md hover:scale-[1.01] transition"
        >
